    ...
    def get_abcd(self, sf, sz, Rinit):
        ...
        if self.dev == 'L':
            ...
            abcd = np.array([[1,sp+2586],[0,1]]).dot(
                   ...
                   np.array([[1,140],[0,1]])).dot(
                   np.array([[1,0],[(1-1.5)/(770*1.5),1/1.5]])).dot(
                   np.array([[1,4929-(2586+140)-sz],[0,1]])).dot(
                   np.array([[1,0],[(1.5-1)/(1200),1.5]])).dot(
                   np.array([[1,20],[0,1]])).dot(
                   np.array([[1,0],[(1-1.5)/(-1200*1.5),1/1.5]])).dot(
                   np.array([[1,5919-(4929+20-sz)-sf],[0,1]])).dot(
                   np.array([[1,0],[(1.5-1)/(-1300),1.5]])).dot(
                   np.array([[1,130],[0,1]])).dot(
                   np.array([[1,0],[(1-1.5)/(1300*1.5),1/1.5]])).dot(
                   np.array([[1,6489-(5919+130-HTf)],[0,1]])).dot(
                   np.array([[1,0],[0,1.5]])).dot(
